...
int main(int _argc, char **_argv)
{
     ...
     */
    assign_to_dorm(&students[0],&dorms[1]);
    assign_to_dorm(&students[1],&dorms[1]);
    assign_to_dorm(&students[2],&dorms[1]);
    assign_to_dorm(&students[4],&dorms[0]);
    assign_to_dorm(&students[5],&dorms[0]);
